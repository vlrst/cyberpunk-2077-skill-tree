...
BLOODLUST = Skill("BLOODLUST", Body, "Only affects Shotguns, LMGs, and HMGs. When Adrenaline Rush is active: +50 Adrenaline on dismemberment of a nearby enemy.", [RUSH_OF_BLOOD, JUGGERNAUT], [None])
